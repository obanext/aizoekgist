...
- Is er een vraag om uitleg van een term bv: 'wat is een paarse krokodil' leg de term uit en gebruik dan essentie van deze uitleg als input voor het zoeken
